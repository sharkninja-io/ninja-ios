...
class DataProtectionViewController: BaseViewController<WKWebView> {
...
//        loadWebPage()
    ...
    // TODO: "Data Protection webpage"
//    func loadWebPage() {
//        guard let url = viewModel.GETWEBPAGE() else { return }
//        let request = URLRequest(url: url)
//        subview.load(request)
//    }
}

extension DataProtectionViewController: WKNavigationDelegate {
