//
//  WifiGrillPersistentFailureView.swift
//  Ninja
//
...
class WifiGrillPersistentFailureView: BaseXIBView {
    ...
    override func setupViews() {
        ...
        pageTitleLabel.text = "JOIN WI-FI"
        ...
        tipContainer.layer.shadowRadius = 4
        tipLabel.text = " Wi-Fi Password Tips"
