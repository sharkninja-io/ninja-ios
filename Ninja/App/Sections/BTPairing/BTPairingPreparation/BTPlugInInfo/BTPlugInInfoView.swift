...
class BTPlugInInfoView: BaseXIBView {
    ...
    override func refreshStyling() {
        ...
        descriptionLabel.setStyle(.pairingLargestInfoLabel)
        item1Label.setStyle(.pairingLargestInfoLabel)
        item2Label.setStyle(.pairingLargestInfoLabel)
